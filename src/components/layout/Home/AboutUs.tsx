  ...
  return (
    ...
    >
      ...
      <div className="mt-10 grid grid-cols-4 gap-4 md:mt-16 md:grid-cols-6 lg:mt-12 lg:grid-cols-12 lg:gap-3 xl:mt-16 xl:gap-5 xxl:mt-[88px]">
        ...
        <div className="col-span-4 h-56 rounded-2xl bg-[url('https://res.cloudinary.com/daxa1bpny/image/upload/v1763427408/ui_assets/BgCardAboutUs.jpg')] bg-cover bg-center bg-no-repeat p-[23px] md:col-span-6 md:p-[23px] lg:col-start-2 lg:col-end-7 lg:row-span-2 lg:h-[382px] lg:p-7 xl:h-[441px] xl:p-8 xxl:h-[583px] xxl:p-11">
        ...
        <div className="col-span-4 flex h-[142px] items-center justify-center rounded-2xl bg-[#EAEAF2] p-5 md:col-span-3 md:h-[188px] md:p-[23px] lg:col-start-7 lg:col-end-12 lg:h-[181px] lg:p-7 xl:h-[210px] xl:p-8 xxl:h-[279px] xxl:p-11">
          <div>
            <h3 className="text-[24px] text-[#3B38A0] md:text-[32px] xl:text-[36px] xxl:text-[52px]">
              Conecte talentos certos
            </h3>
            <div className="mt-[26px] flex items-center justify-between rounded-[14px] bg-white px-[17px] py-[11px] md:px-[21px] md:py-3.5 lg:h-[62px] xl:h-[72px] xxl:h-[100px]">
        ...
        <div className="col-span-4 flex h-[142px] items-end justify-end rounded-2xl bg-primary-light p-5 md:col-span-3 md:h-[188px] md:p-[23px] lg:col-start-7 lg:col-end-12 lg:px-7 lg:pt-0 lg:pb-7 xl:h-[210px] xxl:h-[284px] xxl:px-11">
        ...
        {/* Card nossa proposta */}
        <div className="col-span-4 flex h-[235px] items-center rounded-2xl bg-[#A1A0D1] bg-cover bg-center p-[26px] md:col-span-6 md:h-64 md:bg-[url('/BgNossaProposta.svg')] md:p-0 md:pl-10 lg:col-start-2 lg:col-end-12 lg:h-[272px] lg:px-12 lg:py-0 xl:h-[316px] xl:px-[34px] xxl:h-[434px] xxl:px-[77px]">
