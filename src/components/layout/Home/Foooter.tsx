...
export default function Footer() {
  return (
    <footer className="mt-16 md:mt-28 lg:mt-[121px] xl:mt-[145px] xxl:mt-[202px]">
      <div className="flex flex-col justify-between gap-12 lg:flex-row xxl:justify-normal xxl:gap-0 xxl:px-[41px]">
        ...
        <div className="ml-auto flex flex-col">
          ...
          <div className="mt-6 flex flex-col items-center gap-3 md:flex-row">
            <input
              ...
              className="h-[54px] w-[335px] rounded-[99px] border border-[#35343C] px-5 py-6 text-[14px] focus:border-gray-500 focus:outline-none md:text-[16px] xl:h-14 xl:w-[309px] xxl:h-[70px] xxl:w-[400px] xxl:text-[18px]"
            />
            <button className="flex h-[54px] w-[335px] items-center justify-center rounded-[99px] bg-[#35343C] px-5 py-6 text-[14px] text-white hover:bg-gray-700 md:h-14 md:w-auto md:text-[16px] xxl:h-[70px] xxl:text-[18px]">
              Enviar
            </button>
          </div>
        </div>
