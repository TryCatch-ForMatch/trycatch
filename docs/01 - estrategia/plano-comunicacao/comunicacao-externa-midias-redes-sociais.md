## Documento Operacional — Mídia e Redes Sociais
#### Classificação: Documento Operacional
#### Camada: 2 — Documentos Derivados
...
-	Seja consistente, rastreável e alinhada à documentação oficial.
________________________________________
### 2. Escopo
...
-	Não criar expectativa de contratação, vagas formais ou vínculo empregatício.
________________________________________
### 4. Canais Oficiais
...
________________________________________
### 5. Papel do LinkedIn
O LinkedIn é utilizado como canal institucional para:
...
-	Uso excessivo de informalidade em comunicações institucionais.
________________________________________
### 7. Tipos de Conteúdo Permitidos
São permitidos:
-	Apresentação institucional do TryCatch;
-	Atualizações de projeto;
-	Compartilhamento de aprendizados;
-	Bastidores de organização e processos;
-	Conteúdos educativos de alto nível;
-	Comunicação com a comunidade open source.
________________________________________
### 8. Conteúdos Proibidos
São proibidos:
-	Promessas de contratação ou emprego;
-	Comunicação comercial ou publicitária;
-	Exposição de dados sensíveis;
-	Comparações depreciativas;
-	Conteúdo opinativo não fundamentado;
-	Publicações que conflitem com a documentação oficial.
________________________________________
...
A publicação de conteúdos externos deve:
...
Este documento deriva e deve ser utilizado em conjunto com:
...
Este documento é vivo e poderá evoluir conforme:
